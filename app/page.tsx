   ...
   <div className="min-h-screen bg-black text-gray-100">
      <div className="relative">
       ...
       {/*          <div className="text-gray-500 line-through text-2xl mb-2">R$ 150,00</div> */}
                 {/* <div className="text-5xl font-bold text-red-500 mb-2">R$ 149,90</div> */}
        ...
        <section className="py-20 px-4 bg-gradient-to-b from-black via-red-950/20 to-black relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mb-8">
              <div className="inline-block relative">
                {/* <div className="text-gray-500 text-2xl mb-2">R$ 149,90</div> */}
                <div className="text-5xl font-bold text-red-500 mb-2">R$ 15,50</div>
             {/*  <div className="absolute -top-2 -right-16 bg-red-600 text-white px-3 py-1 rounded-full text-sm font-bold rotate-12">
                  -33%
                </div> */}
                 <div className="absolute -top-8 -right-10 bg-red-600 text-white px-3 py-1 rounded-full text-sm font-bold rotate-12">
                  12x de
                </div> 
              </div>
            </div>
